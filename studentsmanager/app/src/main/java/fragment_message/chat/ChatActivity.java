...
public class ChatActivity extends AppCompatActivity{
    ...
    private void getData() {
        ...
        me_pic = WelcomeActivity.headImg;
    }

    private void initView() {
        tv_name = (TextView)findViewById(R.id.chat_name);
    ...
    private void initMsgs() {
        Msg msg1 = new Msg("刘老师你好，今天我有事可以请个假吗", Msg.TYPE_SENT,me_pic,friendPicId);
        msgList.add(msg1);
        Msg msg2 = new Msg("好的", Msg.TYPE_RECEIVED,me_pic,friendPicId);
        msgList.add(msg2);
    }
