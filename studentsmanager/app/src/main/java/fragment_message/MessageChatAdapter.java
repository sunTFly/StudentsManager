...
public class MessageChatAdapter extends BaseAdapter {
	...
	public MessageChatAdapter(Context context, List<ChatInfo> list) {
	...
	public View getView(final int position, View convertView, final ViewGroup parent) {
		if (convertView == null) {
			vh = new ViewHolder();
			convertView = LayoutInflater.from(context).inflate(R.layout.item_message_chat, null);
			vh.chatPic = (ImageView) convertView.findViewById(R.id.message_chat_Item_img);
			vh.chatName = (TextView) convertView.findViewById(R.id.message_chat_Item_tv_name);
			vh.chatText = (TextView) convertView.findViewById(R.id.message_chat_Item_tv_text);
			vh.chatTime = (TextView) convertView.findViewById(R.id.message_chat_Item_tv_time);
			vh.btn_delete = (Button) convertView.findViewById(R.id.message_chat_delete);
			vh.btn_cancel = (Button) convertView.findViewById(R.id.message_chat_cancel);
		...
		vh.btn_cancel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				isDelete(false);
				fragment_message.chatList.get(position).setDelete(false);
		...
		vh.btn_delete.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				fragment_message.chatList.remove(position);
